...
def build_synthetic_dataset(n_days: int = 180, seed: int = 7) -> pd.DataFrame:
    ...
    anomaly_windows = [
        (72, 79, {"respiratory_visits_index": 0.28, "otc_cold_flu_index": 0.20, "symptom_search_index": 0.22}),
        (106, 112, {"school_absence_index": 0.18, "symptom_search_index": 0.16, "wastewater_proxy_index": 0.14}),
        (142, 150, {"respiratory_visits_index": 0.24, "school_absence_index": 0.15, "wastewater_proxy_index": 0.18}),
    ]
    df["event_label"] = 0
